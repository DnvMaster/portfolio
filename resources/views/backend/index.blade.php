...
<html lang="en">
  <head>
    ...
    <title>DnvMaster - Admin Dashboard</title>
          ...
          <div class="sidebar-content">
            <ul class="nav nav-secondary">
              <li class="nav-item active">
                <a data-bs-toggle="collapse" href="#dashboard" mclass="collapsed" aria-expanded="false">
                  ...
                  <div class="card-body">
                    ...
                    <div class="card-list py-4">
                      ...
                      <div class="item-list">
                        <div class="avatar">
                          <img
                            src="{{ asset('backend/assets/img/talha.jpg') }}" alt="..." class="avatar-img rounded-circle">
                        </div>
                        <div class="info-user ms-3">
                      ...
                      <div class="item-list">
                        ...
                        <div class="info-user ms-3">
                          <div class="username">DnvMaster</div>
